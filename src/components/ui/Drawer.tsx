    ...
    <DrawerPortal>
      <DrawerOverlay>
        <DrawerPrimitives.Content
          ...
          className={cx(
            // base
            "fixed z-50 mx-auto flex w-[95vw] flex-1 flex-col overflow-y-auto p-4 shadow-lg focus:outline-hidden inset-y-0 right-0 sm:max-w-lg sm:p-6 top-0 rounded-none",
            // border color
